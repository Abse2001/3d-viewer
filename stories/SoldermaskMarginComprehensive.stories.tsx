...
export const SoldermaskMarginComprehensive = () => (
  <SoldermaskMarginComprehensiveFixture />
)

export default {
  title: "Soldermask Margin Comprehensive",
  component: SoldermaskMarginComprehensive,
}
